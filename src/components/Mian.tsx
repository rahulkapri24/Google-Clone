    ...
    return (
        <div className="flex flex-col items-center mt-28">
            ...
            <form onSubmit={(e) => onSearchSubmit(e)} className="flex border mt-7 px-5 py-2 rounded-full w-2/5 items-center hover:shadow-md">
                <AiOutlineSearch className="text-xl text-slate-400 hover:text-3xl cursor-pointer" />
                <input 
                    type="text" 
                    className="w-full focus:outline-none ml-4"  placeholder='Search Google or type url'
                ...
                />
                {
                    listening ? 
                        <BsFillMicFill 
                            ...
                            className="text-3xl text-slate-400 mr-5 hover:text-4xl" 
                        />
                    : <BiMicrophone 
